...
export async function DashboardPage() {
    ...
    topGrid.style.marginBottom = 'var(--spacing-lg)';
...
async function fetchWeatherForEvent(event, badge) {
    ...
    try {
        ...
        badge.innerHTML = `
            <div style="font-size: 1.8rem; line-height: 1; margin-bottom: 2px;">☁️</div>
            <div style="font-size: 1.1rem; font-weight: 700; line-height: 1.2;">${Math.round(cloudCover)}%</div>
